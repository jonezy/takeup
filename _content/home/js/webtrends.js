// <!-- Version: 9.4.0 -->
// <!-- FELD M Version: 1.0.0 -->
// <!-- Tag Builder Version: 4.1  -->
// <!-- Created: 8/14/2012 2:16:12 PM -->
// <!-- Customized: 8/17/2012 by FELD M -->
...
function WebTrends(){
	...
	this.splitvalue="";
	this.preserve=false;
	this.cookieTypes = "firstPartyOnly";
	this.FPCConfig = {
...
WebTrends.prototype.dcsFPC=function(){
  ...
  if (this.FPCConfig.anonymize) {
  	//start anonymization:
  	if (WT.co_f.indexOf("-")>-1){			//we have an IP address in WT.co_f
  		var sTempRight=WT.co_f.slice(WT.co_f.indexOf("-"));
  		var sTempLeft=WT.co_f.slice(0, WT.co_f.indexOf("-"));
  		sTempLeft=sTempLeft.slice(0, sTempLeft.lastIndexOf("."));
  		sTempLeft=sTempLeft+".000";
  		WT.co_f=sTempLeft+sTempRight;
  		DCS.dcscip=sTempLeft;				//set dcscip to masked IP
  	} else {
  		DCS.dcscip=WT.co_f;					//set dcssip to script generated id
  	}
  	// end anonymization
  }
